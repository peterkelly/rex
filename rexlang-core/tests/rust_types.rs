...
async fn vec_from_value() {
    ...
    assert_eq!(ty, Type::builtin(rexlang_core::BuiltinTypeId::String));
    assert_pointer_eq!(
        &heap,
        result,
...
async fn vec_to_value() {
    ...
    assert_eq!(
        ty,
        Type::array(Type::builtin(rexlang_core::BuiltinTypeId::I32))
    );
    assert_pointer_eq!(
        &heap,
        result,
...
async fn vec_rex_type() {
    ...
    assert_eq!(
        ty,
        Type::app(
            Type::builtin(rexlang_core::BuiltinTypeId::Array),
...
async fn to_list_allows_pattern_matching_host_arrays() {
    ...
    .await;
    assert_eq!(ty, Type::builtin(rexlang_core::BuiltinTypeId::I32));
...
async fn option_prelude() {
    ...
    assert_eq!(
        ty,
        Type::tuple(vec![
            Type::option(Type::builtin(rexlang_core::BuiltinTypeId::I32)),
            Type::option(Type::builtin(rexlang_core::BuiltinTypeId::I32)),
        ])
    );
    assert_pointer_eq!(
...
async fn option_rex_type() {
    ...
    assert_eq!(
        ty,
        Type::app(
            Type::builtin(rexlang_core::BuiltinTypeId::Option),
            Type::builtin(rexlang_core::BuiltinTypeId::I32)
        )
    );
}
...
async fn result_rex_type() {
    ...
    assert_eq!(
        ...
        Type::app(
            Type::app(
                Type::builtin(rexlang_core::BuiltinTypeId::Result),
                Type::builtin(rexlang_core::BuiltinTypeId::String)
            ),
            Type::builtin(rexlang_core::BuiltinTypeId::I32)
        )
