...
pub use rexlang_engine::{
    ...
    PRELUDE_LIBRARY_NAME, Pointer, PreludeMode, ROOT_LIBRARY_NAME, ReplState, RexAdt, RexDefault,
    RexType, SyncNativeCallable, Value, ValueDisplayOptions, assert_pointer_eq, closure_debug,
    closure_eq, collect_adts_error_to_engine, pointer_display, pointer_display_with, value_debug,
    value_eq, virtual_export_name,
};
...
pub use rexlang_typesystem::{
    ...
    TypeError, TypeKind, TypeSystem, TypeVarSupply, collect_adts_in_types,
