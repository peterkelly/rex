...
pub(crate) fn probe_plan(
    ...
    let mut builder = PlanBuilder::command(ToolProgram::Ffprobe);
...
pub(crate) fn version_plan() -> ToolExecutionPlan {
    let mut builder = PlanBuilder::command(ToolProgram::Ffmpeg);
...
mod tests {
    ...
    fn transcode_plan_keeps_media_paths_symbolic() {
        ...
        .unwrap();
        assert_eq!(plan.program, ToolProgram::Ffmpeg);
