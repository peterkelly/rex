...
pub(crate) fn render_plan(
    ...
    let mut builder = PlanBuilder::new(ToolProgram::ImageMagick);
...
pub(crate) fn transform_many_plan(
    ...
    let mut builder = PlanBuilder::new(ToolProgram::ImageMagickMogrify);
    for operation in operations {
        compile_operation(&mut builder, operation)?;
    }
...
pub(crate) fn identify_plan(
    ...
    let mut builder = PlanBuilder::new(ToolProgram::ImageMagickIdentify);
...
pub(crate) fn compare_plan(
    ...
    let mut builder = PlanBuilder::new(ToolProgram::ImageMagickCompare);
    for option in options {
        match option {
...
pub(crate) fn composite_plan(
    ...
    let mut builder = PlanBuilder::new(ToolProgram::ImageMagickComposite);
    builder.option("-compose", compose_name(&operator));
    for option in options {
        match option {
...
pub(crate) fn montage_plan(
    ...
    let mut builder = PlanBuilder::new(ToolProgram::ImageMagickMontage);
...
pub(crate) fn stream_plan(
    ...
    let mut builder = PlanBuilder::new(ToolProgram::ImageMagickStream);
