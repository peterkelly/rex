...
Rex currently builds the four tool images on each machine and tags them
...
multi-stage capability checks. FFmpeg/ImageMagick/Poppler include DejaVu as a
...
The suite covers all four tools, all output kinds, recursive CAS input/output
