...
//
//   cargo run -p rex --bin rex -- --store-path ./store store import expected.png
//   cargo run -p rex --bin rex -- --store-path ./store store import actual.png
//
...
//     examples/imagemagick/compare_images.rex --inputs inputs.json
//
