...
pub(crate) fn option_from_value(value: Option<Value>) -> Value {
    match value {
...
pub(crate) fn result_from_value(value: Result<Value, Value>) -> Value {
    match value {
...
pub(crate) fn zip_tuple2(xs: Vec<Value>, ys: Vec<Value>) -> Vec<Value> {
    xs.into_iter()
        .zip(ys)
